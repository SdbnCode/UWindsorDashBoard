    ...
    render() {
        return (
            <div className="main">
                ...
                <h2>Culture</h2>
                <p>Windsor has a diverse cultural scene, with various festivals, events, and a vibrant arts community.</p>
                <h2>Sports</h2>
                <p>Ice hockey is a popular sport in Windsor, with the Windsor Spitfires being a prominent junior ice hockey team.</p>
                <h2>Education</h2>
                <p>Windsor is home to the University of Windsor, St. Clair College, and various other educational institutions.</p>
